"""Generate MODEL_TOP3.md from MODEL_SCORES.json (no network)."""
...
def run() -> None:
    payload = core.load_scores_json(REPO_ROOT / "MODEL_SCORES.json")
    md = _render_top3_md(payload=payload)
    core.write_text(REPO_ROOT / "MODEL_TOP3.md", md)
